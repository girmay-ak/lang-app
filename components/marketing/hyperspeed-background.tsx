...
export function HyperspeedBackground({ className, effectOptions }: HyperspeedBackgroundProps) {
  ...
  const mergedOptions = useMemo(() => {
    return {
      ...
      ...effectOptions,
      colors: {
        ...defaultEffectOptions.colors,
        ...(effectOptions?.colors as Record<string, unknown>),
      },
    }
  }, [effectOptions])
  ...
  useEffect(() => {
    ...
    const containerDistortion = distortions[options.distortion] ?? distortions.turbulentDistortion
    options.distortion = containerDistortion
  ...
  return <div className={cn("hyperspeed-root", className)} ref={containerRef} />
}
