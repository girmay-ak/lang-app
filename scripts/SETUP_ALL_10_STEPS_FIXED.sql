-- =====================================================
-- COMPLETE BACKEND SETUP - ALL 10 STEPS (FIXED VERSION)
-- Language Exchange App - Supabase Setup
-- =====================================================
-- This version fixes the "updated_at column does not exist" error
...
-- Conversations Table (handle existing table from Supabase Auth)
...
-- Safely create index on updated_at (only if column exists)
DO $$
BEGIN
  IF EXISTS (
