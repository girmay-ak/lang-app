      ...
      <div className="max-w-md mx-auto px-6 pb-8">
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4 mb-6">
          ...
          {!useMagicLink && (
            <div className="text-right">
              <Link href="/auth/reset-password" className="text-sm text-[#667eea] hover:underline font-medium">
                Forgot password?
              </Link>
            </div>
          )}
          ...
          >
            {isLoading ? (useMagicLink ? "Sending magic link..." : "Signing in...") : useMagicLink ? "Send Magic Link" : "Sign In"}
          </Button>
        ...
        <div className="text-center">
          <p className="text-sm text-gray-600">
            ...
            <Link href="/auth/signup" className="text-[#667eea] hover:underline font-medium">
              Sign up
            </Link>
          </p>
        </div>
